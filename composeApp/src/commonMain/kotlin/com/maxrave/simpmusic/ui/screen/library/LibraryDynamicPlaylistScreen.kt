...
fun LibraryDynamicPlaylistScreen(
    ...
    Box(modifier = Modifier.fillMaxSize().background(MaterialTheme.colorScheme.background)) {
        LazyColumn(
            ...
            val listType = LibraryDynamicPlaylistType.toType(type)
            if (listType == LibraryDynamicPlaylistType.Followed) {
                items(
            ...
            } else if (listType == LibraryDynamicPlaylistType.TopArtists) {
            ...
            } else if (listType == LibraryDynamicPlaylistType.TopAlbums) {
            ...
            } else if (listType == LibraryDynamicPlaylistType.TopTracks) {
                ...
                items(
                    ...
                    SongFullWidthItems(
                        ...
                        onClickListener = { videoId ->
                            viewModel.playSong(videoId, type = listType)
                        },
                        onAddToQueue = {
                            sharedViewModel.addListToQueue(
        ...
        Column(
            ...
            val listType = LibraryDynamicPlaylistType.toType(type)
            val isSongType =
                listType != LibraryDynamicPlaylistType.Followed &&
                    listType != LibraryDynamicPlaylistType.TopArtists &&
                    listType != LibraryDynamicPlaylistType.TopAlbums
            Box {
                TopAppBar(
                    title = {
                        Text(
                    ...
                    actions = {
                        if (isSongType) {
                            RippleIconButton(
                                ...
                                if (listType == LibraryDynamicPlaylistType.TopTracks) {
            ...
            androidx.compose.animation.AnimatedVisibility(visible = showSearchBar) {
                SearchBar(
                    ...
                    inputField = {
                        CompositionLocalProvider(LocalTextStyle provides typo().bodySmall, LocalContentColor provides MaterialTheme.colorScheme.onSurfaceVariant) {
